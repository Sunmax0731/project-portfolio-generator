...
- 作業ディレクトリ: `D:\AI\WebApp\project-portfolio-generator`
...
```powershell
cd D:\AI\WebApp\project-portfolio-generator
npm test
npm start
```
...
5. 静的Webアプリ + CLI生成 の UI または配布面を開き、検証結果をユーザーが次アクションに移せる粒度で確認する。
...
- docs ZIP が `dist/project-portfolio-generator-docs.zip` に存在する。
